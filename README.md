...
The benchmark harness is separate from normal app behavior. It uses a benchmark SQLite DB, generates reports under `benchmark-results/`, and does not change `bun run dev:full` or production routes.
